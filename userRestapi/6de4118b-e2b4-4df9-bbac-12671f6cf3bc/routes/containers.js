...
const upload = require('./../helpers/upload');
    ...
    router.get('/',[
query('container_id').isString().withMessage('Should be string').isLength({min:12}).withMessage('Value should be greater than 12').isLength({max:14}).withMessage('Value should be less than 14')
